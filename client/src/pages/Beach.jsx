...
function Beach() {
    ...
    return (
        ...
        <div>
            ...
            <header>
    <details open>
      <summary>VR expirience & Therapy minigames</summary>
      <p>
        A relaxing virtual expirience that simulates a cartoony version of outer space, meant to be used as a calming space for people who want to relax and zone out for a bit. This space is also where the motor function therapy minigame can be played. *Please note that with the growth of Motion Minds more virtual spaces will be added as well as minigames and expiriences meant to target several other disabilities in the near future*
      </p>
    </details>
  </header>
